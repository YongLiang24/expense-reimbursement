...
<body id="body_">
          <%   
    		...
    		try {
    			while(result.next()) {
    				Reimbursement reimb = new Reimbursement(result.getInt(1), result.getInt(2),result.getString(3),result.getString(4),result.getString(5),result.getString(6),result.getString(7),result.getString(8));	
    				requestList.add(reimb);
    				//System.out.println(result.getString(4));
    				//System.out.println("local list"+reimb.getExpenseDescription());
    			}
